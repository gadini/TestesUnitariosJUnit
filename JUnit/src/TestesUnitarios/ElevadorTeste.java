...
public class ElevadorTeste {
	...
	//Inicializacao da Carga Atual do elevador
	@Before
	...
	//Teste de entrada de duas pessoas na sequencia, no elevador
	@Test
	...
	//Teste de alerta com peso que nao excede a capacidade do elevador
	@Test
